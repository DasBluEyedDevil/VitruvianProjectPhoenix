 ...
 * Based on trainer's SampleStatus class.
 */
...
data class SampleStatus(val raw: Int) {
    ...
    companion object {
        // Constants derived from trainer's SampleStatus enum (bit masks)
        // Note: The trainer code shows bit shifts like `1 << 0`, `1 << 1`, etc.
        // DELOAD_OCCURRED is bit 15 (0x8000) -> 1 << 15 = 0x8000
