package com.ninthlevel.phoenix.data.logger
    ...
    fun logConnectionSuccess(deviceName: String, deviceAddress: String) {
        ...
        log(
            ...
            details = buildString {
                ...
                appendLine("To check firmware manually: Settings -> About on the trainer touchscreen")
            },
