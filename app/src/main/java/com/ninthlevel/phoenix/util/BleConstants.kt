...
/**
 * BLE Constants - UUIDs and configuration values for device communication
...
object BleConstants {
    ...
    // Unknown/Auth characteristic - present in the notification list
    ...
    // NOT a NotifiableCharacteristic per device protocol.
    ...
    // Workout command characteristics ()
    ...
    object Commands {
        ...
        const val RESET_COMMAND: Byte = 0x0A       // Reset/init (legacy stop) - recovery fallback
