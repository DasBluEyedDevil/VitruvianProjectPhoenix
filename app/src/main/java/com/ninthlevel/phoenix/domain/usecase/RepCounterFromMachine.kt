package com.ninthlevel.phoenix.domain.usecase

import com.ninthlevel.phoenix.domain.model.RepCount
import com.ninthlevel.phoenix.domain.model.RepEvent
import com.ninthlevel.phoenix.domain.model.RepType
import timber.log.Timber
import kotlin.math.max

/**
 * Handles rep counting based on notifications emitted by the machine.
 *
 * REP COUNTING APPROACH (visual pending/completed rep feedback):
...
class RepCounterFromMachine {
    ...
    private fun processLegacy(up: Int, down: Int, posA: Float, posB: Float) {
        if (lastTopCounter != null) {
            ...
            if (topDelta > 0) {
                ...
                // Count the rep at TOP of movement (matches Beta 4 / trainer behavior)
     ...
     * This is the trainer method with pending rep visual feedback.
     */
